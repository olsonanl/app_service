...
function AppService(url, auth, auth_cb) {
    ...
    this.query_task_summary_filtered = function (simple_filter, _callback, _errorCallback) {
    return json_call_ajax("AppService.query_task_summary_filtered",
        [simple_filter], 1, _callback, _errorCallback);
};

    this.query_task_summary_filtered_async = function (simple_filter, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("AppService.query_task_summary_filtered", [simple_filter], 1, _callback, _error_callback);
    };

    this.query_app_summary_filtered = function (simple_filter, _callback, _errorCallback) {
    return json_call_ajax("AppService.query_app_summary_filtered",
        [simple_filter], 1, _callback, _errorCallback);
};

    this.query_app_summary_filtered_async = function (simple_filter, _callback, _error_callback) {
        deprecationWarning();
